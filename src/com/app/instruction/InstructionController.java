...
import com.app.utils.InstructionAttributeLoader;
 ...
 public class InstructionController 
 {
	...
	public void Initialize_Instructions(String tutor_text, String student_text, Image tutor, Image student)
	{
			...
			instruction_Tutor.setPosX(290);
			instruction_Tutor.setPosY(50);
			instruction_Tutor.setWidth(350);
			instruction_Tutor.setHeight(150);
			...
			instruction_Student.setPosX(290);
			instruction_Student.setPosY(50);
			instruction_Student.setWidth(350);
			instruction_Student.setHeight(150);
